...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/yd/testData/">移动加班和异常成功列表</a></li>
		<shiro:hasPermission name="yd:testData:edit"><li><a href="${ctx}/yd/testData/form">移动加班和异常成功添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="testData" action="${ctx}/yd/testData/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="yd:testData:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="testData">
			<tr>
				<td><a href="${ctx}/yd/testData/form?id=${testData.id}">
					${testData.user.name}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="yd:testData:edit"><td>
    				<a href="${ctx}/yd/testData/form?id=${testData.id}">修改</a>
					<a href="${ctx}/yd/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该移动加班和异常成功吗？', this.href)">删除</a>
