...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/yd/testData/">移动加班和异常成功列表</a></li>
		<li class="active"><a href="${ctx}/yd/testData/form?id=${testData.id}">移动加班和异常成功<shiro:hasPermission name="yd:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="yd:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/yd/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="yd:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
