...
<head>
	...
	<script type="text/javascript">
		...
		function back(){
			...
			window.location.href = "/cdyidong/a/yuekaoqinall/ydYeukaoqinAll/deptkaoqin";
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="">部门月考勤记录列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="attendanceDay" action="${ctx}/yuekaoqin/attendanceDay/renziyuekaoqin" method="post" class="breadcrumb form-search">
